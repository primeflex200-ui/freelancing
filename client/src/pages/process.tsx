  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 z-0 overflow-hidden">
        ...
        >
          <source src="/process-background.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10">
        ...
        <main className="pt-32 pb-20">
          <div className="container mx-auto px-4">
            ...
            >
              <div className="glass p-8 rounded-2xl border-2 border-white/20 bg-white/10 backdrop-blur-md">
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  <div className="flex gap-8 items-start">
                    {/* Number */}
                    <div className="flex-shrink-0">
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                        {step.number}
                      </div>
                    </div>
